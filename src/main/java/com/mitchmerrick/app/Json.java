...
//     Submarine(src.main.java.Json ob)
//     {
...
//         src.main.java.Json tmpList = ob.get("ammo");
...
//     src.main.java.Json marshal()
//     {
//         src.main.java.Json ob = src.main.java.Json.newObject();
//         ob.add("atomic", atomic);
//         ob.add("crewSize", crewSize);
//         ob.add("depth", depth);
//         ob.add("peri", peri.marshal());
//         src.main.java.Json tmpList = src.main.java.Json.newList();
//         ob.add("ammo", tmpList);
